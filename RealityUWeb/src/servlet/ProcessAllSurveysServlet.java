...
import processSurveys.CustodyChildSupportFemales;
import processSurveys.CustodyChildSupportMales;
import processSurveys.ProcessChildren;
import processSurveys.ProcessChildrenDivorcedFemales;
import processSurveys.ProcessChildrenDivorcedMales;
        	...
        	//Process Surveys if "submit" button clicked
         	if (request.getParameter("submit") != null) {
	    		...
	    		if (lstSurveys.size() > 19) {
	    			...
	    			lstSurveys = new CustodyChildSupportMales().doProcess(lstSurveys);
	    			lstSurveys = new CustodyChildSupportFemales().doProcess(lstSurveys);
